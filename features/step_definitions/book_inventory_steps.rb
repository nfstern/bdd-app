...
Then('I should see a list of my books') do
...
Given('I have a book in my inventory') do
  FactoryBot.create(:book, user: @registered_user, name: 'War and Peace', author: 'Leo Tolstoy')
end
...
Then('I should not see it in the listing in the inventory anymore') do
  expect(page).to_not have_content('War and Peace')
end
